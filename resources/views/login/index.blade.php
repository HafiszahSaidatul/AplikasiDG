...
<body>
    ...
    @endif   
       ...
       <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #b90505;">
           ...
           <small class="text-white text-wrap text-center" style="width: 17rem;font-family: 'Courier New', Courier, monospace;">Selamat datang di Dashboard Stok Barang</small>
       </div> 
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <div class="input-group mb-4">
                    <button class="btn btn-lg btn-danger w-100 fs-7" type="submit">Masuk</a></button>
                </form>
                </div>
                <div class="input-group mb-3">
                </div>
                <div class="row">
                    <small>Tidak punya akun? <a href="/register">Klik disini untuk daftar</a></small>
                </div>
          </div>
       </div> 
      </div>
